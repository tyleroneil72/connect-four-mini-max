...
public class Board {
    ...
    // incorporating players withing the board class to make minimax integration easier.
    ...
    public void makeMove(Move move){
        ...
        // print after move has been made outside the board class or in another function.
    }
    ...
    /*
     * Two pointer approach used to check horizontal and diagonal wins. Replacing checking entire rows and entire diags.
     * 2 direction pointers are initialized along with a counter, check until you have same token at the directional pointer
    ...
    public int evalMoveScore(int col, int target)
    {
        ...
        /* 
         * score for a column should be a static value regardless of whether a maximizer or minimizer is playing.
         * weight of a token/coin (w) is evaluated using the following exponential polynomial.
         * w +=  m * n * (a ^  n)
         * 'n' (counter) is the position of the token in the current sequence being evaluated, (1 in chain, 2nd in chain and so on)
         * 'a' and 'm' are amplifying factors, where m emphasizes greater value if the token being checked is of the same color as the player making the move.
         * and a is used to provide a greater distinction in value between chains of 2 and chains of 3.
         */
    ...
    public int[] getScoresForMoves(int target) // returns an array where element at each index corresponds to the score for that column.
    {
    ...
    {
        // sorting using insertion sort alg so that most of the base sequence is still maintained even if scores are 0.
        // that is, if no significant evaluation can be made based on the current state, check in order of center to edge.
